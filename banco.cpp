...
void Banco::rescribirArchivoBinario(std::string contenidoTexto,const std::string& nombreArchivoBinario){
...
void Banco::rescribirArchivoBinario(std::string contenido,const std::string& nombreArchivoBinario,const int& m, const int& n){
    std::string binario=deTextoABinario(contenido);
    std::string binarioCodificado=codificar(binario,m,n);
    std::ofstream archivo_binario(nombreArchivoBinario, std::ios::binary);
    if (!archivo_binario.is_open()) {
        std::cerr << "No se pudo abrir el archivo." << std::endl;
        return ;
